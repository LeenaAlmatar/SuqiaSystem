...
import 'package:first_app/screens/directionsVist.dart';
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (context) => TankListVist()));
          },
        ),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  height: 100,
                  child:Image.asset(
                    status == 'Empty'  ? "assets/Gtank.png" : "assets/tank.png",
                  ),
                ),
                SizedBox(
                  width: 7,
