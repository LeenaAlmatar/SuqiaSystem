...
import 'package:suqia/screens/TankInfoEmp.dart'; // Import TankInfoEmp if needed
      ...
      snapshot.docChanges.forEach((change) {
        if (change.type == DocumentChangeType.modified) {
          ...
          if (tankData['status'] == 'Empty') {
            _showTankStatusNotification(tankData['tankNumber']);
          }
        }
      });
    });
  ...
  void _showTankStatusNotification(String tankNumber) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Tank Status Changed'),
          content: Text('Tank $tankNumber is now empty. Please refill it.'),
          actions: <Widget>[
            TextButton(
              child: Text('Dismiss'),
              onPressed: () {
